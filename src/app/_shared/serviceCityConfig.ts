...
export const mascotsByService: Record<ServiceKey, string> = {
  ...
  caldaie: "/mascotte/caldaie-2.webp",           // puoi cambiare in caldaie.png o caldaie-1.webp se preferisci
...
// fallback sicuro
export function mascotFor(svc: ServiceKey | string) {
  const key = svc as ServiceKey;
  return mascotsByService[key] ?? "/mascotte/capitansos-mappa.webp";
}
...
export const cityCopy: Record<string, Record<string, CityCopy>> = {
  idraulico: {
    roma: {
      titleH1: "Idraulico Roma – SOS24ORE",
      subH1: "Pronto intervento H24 a Roma. Seleziona il quartiere o contattaci.",
      lead: "Per perdite, allagamenti, wc otturati o guasti a Roma, interveniamo rapidamente con tecnici selezionati.",
      pills: [
  ...
  vetraio: {
    roma: {
      ...
      lead: "Riparazioni rapide su vetri rotti, infissi e vetrine negozio, con sopralluoghi urgenti.",
      pills: [
      ...
      faqs: [{ q: "Vetrine negozi?", a: "Sì, dove disponibile interveniamo anche su vetrine." }],
    },
  },
};
